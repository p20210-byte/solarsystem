...
if planet_choice == '목성':
    satellite_choice = st.selectbox('위성을 선택해주세요', planets['목성']['대표적인 위성'])
    st.write(satelliteJ_data[satellite_choice])

elif planet_choice == '토성':
    satellite_choice = st.selectbox('위성을 선택해주세요', planets['토성']['대표적인 위성'])
    st.write(satelliteS_data[satellite_choice])

elif planet_choice == '천왕성':
    satellite_choice = st.selectbox('위성을 선택해주세요', planets['천왕성']['대표적인 위성'])
    st.write(satelliteU_data[satellite_choice])

elif planet_choice == '해왕성':
    satellite_choice = st.selectbox('위성을 선택해주세요', planets['해왕성']['대표적인 위성'])
